...
### Purpose
This document provides the formal version description for the Wayside Monitor System (WMS) release v0.5, detailing the software configuration, changes, and validation evidence required for promotion from DEV to TEST.
...
- **Container Image**: `ghcr.io/federicomameli1/wayside-monitor:v0.5`
...
---
_Auto-drafted by Verdict on release `v0.5`._